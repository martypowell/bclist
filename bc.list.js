var BcList = (function (window, undefined, $, Handlebars) {
    ...
    var BcList = function (options) {
        ...
        this.noRecordsMessage = options.hasOwnProperty('noRecordsMessage') ? options.noRecordsMessage : "<h3>No Records Found</h3>";
    ...
    BcList.prototype.Show = function (data) {
        var _this = this;
        this.Get(data, function (resp) {
            _this.Render(resp, _this);
        });
    };

    BcList.prototype.Render = function (resp, _this) {
